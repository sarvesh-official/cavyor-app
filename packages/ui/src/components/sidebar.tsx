        ...
        <div className="flex items-center justify-center p-4 border-b border-sidebar-border">
          {!collapsed && (
            <div className="flex items-center space-x-2">
              ...
              <span className="font-semibold text-sidebar-foreground text-lg">Cavyor</span>
            </div>
          )}
          {collapsed && (
            <div className="w-8 h-8 bg-sidebar-primary rounded-full flex items-center justify-center mx-auto">
              <span className="text-sidebar-primary-foreground font-bold text-sm">C</span>
            </div>
          )}
          {onToggleCollapse && (
                  ...
                  return (
                    <Button
                      ...
                      className={cn(
                        ...
                        isActive ? "bg-red-600 text-white hover:bg-red-700" : "text-sidebar-foreground hover:text-sidebar-foreground hover:bg-sidebar-accent",
